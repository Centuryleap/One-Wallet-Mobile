...
import 'package:one_wallet/views/widgets/bank_list_widget.dart';
import 'package:one_wallet/views/widgets/no_card_available_widget.dart';
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: darkMode ? const Color(0xff24017D) : const Color(0xff02003D),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Welcome back',
                                style: TextStyle(
                                  color: darkMode ? const Color(0xffEEEEEE) : const Color(0xffAAA8BD),
                                  fontFamily: sfpro,
                              ...
                              GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    borderRadius: BorderRadius.circular(16),
                                    color: darkMode ?  const Color(0xff3F208D) : const Color(0xffFFFFFF)
                                        .withOpacity(.24),
                                  ),
                                  child: Text('Add Card',
                                      style: TextStyle(
                      ...
                      children: [
                        Text(
                          ...
                          style: TextStyle(
                              fontFamily: sfpro,
                              fontSize: 16.sp,
                              color: darkMode ? const Color(0xffFFFFFF) : const Color(0xff505780),
                              fontWeight: FontWeight.w400),
                        ),
                        Text('',
                            style: TextStyle(
